...
Image.create!([
  ...
  {project_id: 9, nature: "photo", url: "01-UntitledCollection_sdnfpj", format: "portrait"},
  {project_id: 9, nature: "photo", url: "02-UntitledCollection_t2m3yv", format: "portrait"},
  {project_id: 9, nature: "photo", url: "03-UntitledCollection_doi78v", format: "portrait"},
  {project_id: 9, nature: "photo", url: "04-UntitledCollection_ytoul3", format: "portrait"},
  {project_id: 9, nature: "photo", url: "05-UntitledCollection_ro6lk0", format: "portrait"},
  {project_id: 9, nature: "photo", url: "06-UntitledCollection_ljtoyw", format: "portrait"},
  {project_id: 9, nature: "photo", url: "07-UntitledCollection_ekais1", format: "portrait"},
  {project_id: 9, nature: "photo", url: "08-UntitledCollection-Cool-Ruler_ybxpqr", format: "portrait"},
  {project_id: 7, nature: "videostill", url: "08-videosill-tate_jn990x", format: "landscape"},
  {project_id: 7, nature: "videostill", url: "07-videosill-tate_zpxcwi", format: "landscape"},
  {project_id: 7, nature: "videostill", url: "06-videosill-tate_owm3jd", format: "landscape"},
  {project_id: 7, nature: "videostill", url: "05-videosill-tate_tkjaok", format: "landscape"},
  {project_id: 7, nature: "videostill", url: "04-videosill-tate_kq3vqv", format: "landscape"},
  {project_id: 7, nature: "videostill", url: "03-videosill-tate_fteysa", format: "landscape"},
  {project_id: 7, nature: "videostill", url: "02-videosill-tate_rajhbf", format: "landscape"},
  {project_id: 7, nature: "videostill", url: "01-videosill-tate_s3mptd", format: "landscape"},
  {project_id: 6, nature: "printable", url: "10-print-Helmet-like_c2c8lr", format: "landscape"},
  {project_id: 6, nature: "printable", url: "09-print-Helmet-like_t9n8r4", format: "landscape"},
  {project_id: 6, nature: "photo", url: "08-photo-Helmet-like_qx7enp", format: "portrait"},
  {project_id: 6, nature: "photo", url: "07-photo-Helmet-like_se2lxb", format: "portrait"},
  {project_id: 6, nature: "photo", url: "06-photo-Helmet-like_pawztv", format: "portrait"},
  {project_id: 6, nature: "photo", url: "05-photo-Helmet-like_artxjq", format: "portrait"},
  {project_id: 6, nature: "photo", url: "04-photo-Helmet-like_hnnyws", format: "portrait"},
  {project_id: 6, nature: "photo", url: "03-photo-Helmet-like_auogvm", format: "portrait"},
  {project_id: 6, nature: "photo", url: "02-photo-Helmet-like_vu0ecw", format: "portrait"},
  {project_id: 6, nature: "photo", url: "01-photo-Helmet-like_ez9ctm", format: "portrait"},
  ...
  {project_id: 4, nature: "photo", url: "01-photo-London-Parallel_sglyqz", format: "landscape"},
  {project_id: 4, nature: "photo", url: "02-photo-London-Parallel_eayw3m", format: "landscape"},
  {project_id: 4, nature: "videostill", url: "07-videostill-London-Parallel_p0ko44", format: "landscape"},
  {project_id: 4, nature: "videostill", url: "06-videostill-London-Parallel_anx2ym", format: "landscape"},
  {project_id: 4, nature: "videostill", url: "05-videostill-London-Parallel_chbfke", format: "landscape"},
  {project_id: 4, nature: "videostill", url: "04-videostill-London-Parallel_qvlqbq", format: "landscape"},
  {project_id: 4, nature: "videostill", url: "03-videostill-London-Parallel_ao3fsb", format: "landscape"},
  {project_id: 3, nature: "printable", url: "07-print-Knockout_oacszw", format: "landscape"},
  {project_id: 3, nature: "printable", url: "06-print-Knockout_wrtdun", format: "landscape"},
  {project_id: 3, nature: "photo", url: "01-photo-Knockout_usmwkc", format: "landscape"},
  {project_id: 3, nature: "videostill", url: "05-videostill-Knockout_ph8jpl", format: "landscape"},
  {project_id: 3, nature: "videostill", url: "04-videostill-Knockout_j1pxke", format: "landscape"},
  {project_id: 3, nature: "videostill", url: "03-videostill-Knockout_ph9sg1", format: "landscape"},
  {project_id: 3, nature: "videostill", url: "02-videostill-Knockout_xzakhd", format: "landscape"},
  ...
  {project_id: 2, nature: "printable", url: "03-print-Insectbite_tt80gn", format: "landscape"},
  {project_id: 2, nature: "printable", url: "04-print-Insectbite_yssvih", format: "landscape"},
  {project_id: 2, nature: "videostill", url: "05-insectbite-video-still_evcy3j", format: "landscape"},
  {project_id: 2, nature: "photo", url: "01-photo-Insectbite_pb3yrx", format: "portrait"},
  {project_id: 2, nature: "videostill", url: "06-insectbite-video-still_dxwrpv", format: "landscape"},
  {project_id: 2, nature: "photo", url: "02-photo-Insectbite_yq5nuk", format: "portrait"},
  {project_id: 2, nature: "videostill", url: "07-insectbite-video-still_zjenbf", format: "landscape"},
  {project_id: 2, nature: "videostill", url: "08-insectbite-video-still_z7sauc", format: "landscape"},
])
